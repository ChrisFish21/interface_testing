...
class untitled(App):
    ...
    def construct_ui(self):
        ...
        base.style.update({"margin":"0px","width":"98%","height":"98%","top":"1%","left":"1%","position":"absolute","overflow":"hidden","border-style":"solid"})
        ...
        lower_hor_cont.style.update({"margin":"0px","width":"100%","height":"20%","top":"80%","left":"0%","position":"absolute","overflow":"hidden","border-style":"solid"})
        ...
        status_housing.style.update({"margin":"0px","width":"40%","height":"100%","position":"absolute","overflow":"scroll","border-style":"solid"})
        ...
        pan_housing.style.update({"margin":"0px","width":"15%","height":"100%","left":"40%","position":"absolute","overflow":"hidden","border-style":"solid"})
        pan_label = Label('PAN')
        ...
        tilt_housing.style.update({"margin":"0px","width":"15%","height":"100%","left":"55%","position":"absolute","overflow":"hidden","border-style":"solid"})
        ...
        zoom_housing.style.update({"margin":"0px","width":"15%","height":"100%","left":"70%","position":"absolute","overflow":"hidden","border-style":"solid"})
        ...
        cam_set_housing.style.update({"margin":"0px","width":"15%","height":"100%","left":"85%","position":"absolute","overflow":"hidden","border-style":"solid"})
